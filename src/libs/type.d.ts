 ...
 *
 * @see QuizA: 단일/다중/사칙연산 문제
 * @see QuizB: 드래그 문제
 */
type Quiz = QuizA | QuizB

/**
 * 각 문제의 풀이 기록을 저장하는 인터페이스
 */
interface QuizHistory {
  topic: string /* 문제 주제 */
  isAllCorrect: boolean /* 각 문제의 모든 정답이 맞혔는지 여부) */
  isCorrect: boolean[] /* 각 정답 선택지별로 맞았는지 여부 배열 */
  answer: string[] /* 정답 리스트 */
}
